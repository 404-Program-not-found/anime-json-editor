...
function createModalAdd (){
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                <button type="button" class="btn btn-dark btn-small modal-btn" id="addCardBtn"><i class="fas fa-id-badge"></i>Card</button>
                <button type="button" class="btn btn-dark btn-small modal-btn" id="addBtnBtn"><i class="fas fa-link"></i>Button</button>
